...
declare namespace Gentyl {
    ...
    class GContext {
        ...
        borrowTractorContext(): this;
        returnTractorContext(returned: any): void;
        prepare(): void;
        extract(): any;
...
declare namespace Gentyl {
    class BaseNode {
        ...
        protected prepareChild(prepargs: any, child: any): BaseNode;
        protected setParent(parentNode: BaseNode): void;
        replicate(): BaseNode;
