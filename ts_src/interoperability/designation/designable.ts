namespace Jungle {
    export namespace IO {
        ...
        export namespace Designate {
            ...
            export function parseDesignatorString(desigstr:string, targetRole:string):CruxDesignator{
            ...
            export function tokenDesignatedBy(token, designator:CruxDesignator):boolean{
